...
export default function FeatureCard({ title, description, href, onLearnMore }: FeatureCardProps) {
  return (
    <div className="rounded-xl border border-black/10 dark:border-white/10 p-6 bg-white/50 dark:bg-white/5 shadow-sm hover:shadow transition-shadow">
      ...
      <div>
        {onLearnMore ? (
          <button onClick={onLearnMore} className="inline-flex items-center gap-2 text-sm font-medium text-foreground hover:underline underline-offset-4">
            Learn More
